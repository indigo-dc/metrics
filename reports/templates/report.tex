...
\begin{tabular}{ll}
    ...
    \hyperref[sec:configuration]{Automated deployment} & \BLOCK{if product.config_management.wp3_in_progress}\graybox{IN PROGRESS - WP3}\BLOCK{elif product.config_management.tool}\greenbox{COMPLETE}\BLOCK{elif product.config_management.wont_be_provided}\greenbox{COMPLETE}\BLOCK{else}\redbox{NOT COMPLETE}\BLOCK{endif} \\
\end{tabular}
\end{center}
...
%\BLOCK{if product.func_int_test.url}
%Test at \VAR{product.func_int_test.url}.
%\BLOCK{else}
...
\href{\VAR{job_data.job_url}}{\VAR{job_name}}.
\BLOCK{endfor}
\BLOCK{elif product.func_int_test.url}
