...
\begin{center}
    ...
    %\\[0.5em] 
    %\BLOCK{if product.tasks.parent.progress < 25}
    %    \redbox{\strut \begin{huge}\VAR{product.tasks.parent.progress}\% done\end{huge}}
    %\BLOCK{elif product.tasks.parent.progress < 50}
    %    \orangebox{\strut \begin{huge}\VAR{product.tasks.parent.progress}\% done\end{huge}}
    %\BLOCK{elif product.tasks.parent.progress < 75}
    %    \yellowbox{\strut \begin{huge}\VAR{product.tasks.parent.progress}\% done\end{huge}}
    %\BLOCK{else}
    %    \graybox{\strut \begin{huge}\VAR{product.tasks.parent.progress}\% done\end{huge}}
    %\BLOCK{endif} \\
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:code_style]{Code style adherence} & \BLOCK{if product.code_style.data}\greenbox{COMPLETE}\BLOCK{else}\redbox{NOT COMPLETE}\BLOCK{endif} \\
    ...
    \hyperref[sec:func_int_test]{Functional/integration testing} & \BLOCK{if product.func_int_test.wp3_in_progress}\graybox{IN PROGRESS - WP3}\BLOCK{elif product.func_int_test.url}\greenbox{COMPLETE}\BLOCK{else}\redbox{NOT COMPLETE}\BLOCK{endif} \\
    ...
    \hyperref[sec:configuration]{Automated deployment} & \BLOCK{if product.config_management.tool}\greenbox{COMPLETE}\BLOCK{else}\redbox{NOT COMPLETE}\BLOCK{endif} \\
\end{tabular}
\end{center}
...
\BLOCK{if not product.func_int_test.url and not product.func_int_test.wp3_in_progress}
