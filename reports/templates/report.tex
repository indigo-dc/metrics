...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\BLOCK{if product.status_complete }\greenbox{\strut COMPLETE}\BLOCK{elif product.status_notcomplete}\redbox{\strut NOT COMPLETE (\VAR{product.tasks.parent.progress}\% done)}\BLOCK{elif product.status_inprogress}\graybox{\strut IN PROGRESS}\BLOCK{endif} \\
\end{center}
...
Last build status on Jenkins CI \href{\VAR{product.code_style.job_url}}{\VAR{product.code_style.jenkins_job}}.
