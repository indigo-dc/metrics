...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (48\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=48]{\textbf{\#2843} OOI (OpenStack OCCI Interface) SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/ooi.git}\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/ooi-codestyle/3}{ooi-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_ooi-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=97.61905]{Files (41.0/42.0)}{1}{3} \\
            \ganttbar[progress=97.61905]{Classes (41.0/42.0)}{1}{3} \\
            \ganttbar[progress=95.68788]{Lines (1864.0/1948.0)}{1}{3} \\
            \ganttbar[progress=91.203705]{Conditionals (394.0/432.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
