...
\href{https://jenkins.indigo-datacloud.eu:8080//job/ooi-codestyle/4}{ooi-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=90.86519]{Lines (2258.0/2485.0)}{1}{3} \\
            \ganttbar[progress=80.866425]{Conditionals (448.0/554.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/ooi-unittest/6}{ooi-unittest}.
