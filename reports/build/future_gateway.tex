...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (33\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=33]{\textbf{\#3809} FutureGateway API Server SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/FutureGateway-APIServer.git}\end{center}


\input{title_codestyle.tex}
\label{sec:code_style}
\begin{tabular}{ll}
    Code style definition & \href{http://web.archive.org/web/20090911103851/http://java.sun.com/docs/codeconv/html/CodeConvTOC.doc.html}{Code Conventions for the JavaTM Programming Language} \\
    Community/de-facto standard & \graybox{Yes} \\
    Exceptions & \graybox{1 (DesignForExtension)} \\
...
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/futuregateway-codestyle/3}{futuregateway-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_futuregateway-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=0.0]{Packages (0.0/10.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Files (0.0/46.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Classes (0.0/57.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Methods (0.0/247.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Lines (0.0/1231.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Conditionals (0.0/326.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/futuregateway-unittest/3}{futuregateway-unittest}.
