...
\title{Software Quality Assurance (SQA) Report \\[0.7em] \large{13-17 Jun 2016}\\[1.5em] 
       \huge{\texttt{INDIGO Plug-ins for scientific workflow systems}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (25\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=25]{\textbf{\#3530} INDIGO Plug-ins for scientific workflow systems SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/indigokepler}\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/indigokepler-codestyle/4}{indigokepler-codestyle}.

\subsection{Observations}
\begin{enumerate}
        \item Job fails to run due to a dependency issue (with indigoclient).
    \end{enumerate}
