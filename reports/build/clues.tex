...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=63]{\textbf{\#3086} CLUES SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/clues-codestyle/2}{clues-codestyle}.

\subsection{Observations}
\begin{enumerate}
        \item Progress is 50\% since the product is adhered to a standard (pep8) but the code is not yet compliant.
    \end{enumerate}
...
\subsection{Observations}
\begin{enumerate}
        \item Job has not yet been defined (WP3 duty). There are some errors arising when using pytest (for cobertura support).
    \end{enumerate}
