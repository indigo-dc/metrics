...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=73]{\textbf{\#3026} ONEDock SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/onedock-codestyle/28}{onedock-codestyle}.
