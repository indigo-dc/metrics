...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (58\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=58]{\textbf{\#3026} ONEDock SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/onedock-codestyle/22}{onedock-codestyle}.
