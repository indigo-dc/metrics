...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{44\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=50]{\textbf{\#3767} opie (OpenStack Preemptible Instances Extension) SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/opie}\end{center}
