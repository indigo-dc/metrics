...
\href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-codestyle/33}{orchestrator-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=89.47369]{Packages (17.0/19.0)}{1}{3} \\
            \ganttbar[progress=85.71429]{Files (48.0/56.0)}{1}{3} \\
            \ganttbar[progress=77.77778]{Classes (49.0/63.0)}{1}{3} \\
            \ganttbar[progress=56.338028]{Methods (200.0/355.0)}{1}{3} \\
            \ganttbar[progress=40.76389]{Lines (587.0/1440.0)}{1}{3} \\
            \ganttbar[progress=22.857143]{Conditionals (88.0/385.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/26}{orchestrator-unittest}.
