...
\href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-codestyle/58}{orchestrator-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=89.89899]{Files (89.0/99.0)}{1}{3} \\
            \ganttbar[progress=81.57895]{Classes (93.0/114.0)}{1}{3} \\
            \ganttbar[progress=55.137844]{Methods (440.0/798.0)}{1}{3} \\
            \ganttbar[progress=39.382633]{Lines (1161.0/2948.0)}{1}{3} \\
            \ganttbar[progress=24.752476]{Conditionals (200.0/808.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/52}{orchestrator-unittest}.
