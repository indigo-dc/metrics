...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=87.878784]{Files (87.0/99.0)}{1}{3} \\
            \ganttbar[progress=80.70175]{Classes (92.0/114.0)}{1}{3} \\
            \ganttbar[progress=54.282116]{Methods (431.0/794.0)}{1}{3} \\
            \ganttbar[progress=39.140812]{Lines (1148.0/2933.0)}{1}{3} \\
            \ganttbar[progress=26.05459]{Conditionals (210.0/806.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/36}{orchestrator-unittest}.
