...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=39.106716]{Lines (1147.0/2933.0)}{1}{3} \\
            \ganttbar[progress=26.05459]{Conditionals (210.0/806.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/32}{orchestrator-unittest}.
