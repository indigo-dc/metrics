...
\href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-codestyle/41}{orchestrator-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=79.36508]{Classes (50.0/63.0)}{1}{3} \\
            \ganttbar[progress=59.15493]{Methods (210.0/355.0)}{1}{3} \\
            \ganttbar[progress=42.01389]{Lines (605.0/1440.0)}{1}{3} \\
            \ganttbar[progress=22.857143]{Conditionals (88.0/385.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/34}{orchestrator-unittest}.
