...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (55\% done)} \\
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{30\%} \\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=55]{\textbf{\#3089} Orchestrator SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/orchestrator.git}\end{center}


\input{title_codestyle.tex}
\label{sec:code_style}
\begin{tabular}{ll}
    Code style definition & \href{https://google.github.io/styleguide/javaguide.html}{Google Java Style} \\
    Community/de-facto standard & \graybox{Yes} \\
    Exceptions & \graybox{0} \\
...
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-codestyle/22}{orchestrator-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_orchestrator-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=88.46154]{Packages (23.0/26.0)}{1}{3} \\
            \ganttbar[progress=87.5]{Files (84.0/96.0)}{1}{3} \\
            \ganttbar[progress=77.47748]{Classes (86.0/111.0)}{1}{3} \\
            \ganttbar[progress=53.289474]{Methods (405.0/760.0)}{1}{3} \\
            \ganttbar[progress=38.014183]{Lines (1072.0/2820.0)}{1}{3} \\
            \ganttbar[progress=26.0582]{Conditionals (197.0/756.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/18}{orchestrator-unittest}.
