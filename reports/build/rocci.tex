...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (75\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=75]{\textbf{\#2906} rOCCI SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/rOCCI-server.git}\end{center}
