...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{49\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=67]{\textbf{\#2867} tts SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/tts-codestyle/100}{tts-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=60.0]{Files (15.0/25.0)}{1}{3} \\
            \ganttbar[progress=60.0]{Classes (15.0/25.0)}{1}{3} \\
            \ganttbar[progress=70.47913]{Lines (912.0/1294.0)}{1}{3} \\
...
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/tts-unittest/86}{tts-unittest}.
...
%%Test at https://jenkins.indigo-datacloud.eu:8080/job/tts-functional/.
%
Tests are defined in a \href{https://jenkins.indigo-datacloud.eu:8080/job/tts-functional/}{external CI service}.
