...
\href{https://jenkins.indigo-datacloud.eu:8080//job/tts-codestyle/58}{tts-codestyle}.
...
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/tts-unittest/44}{tts-unittest}.
