...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=67]{\textbf{\#2867} Token Translation Service SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/tts-codestyle/64}{tts-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=49.07926]{Lines (613.0/1249.0)}{1}{3} \\
            \ganttbar[progress=100.0]{Conditionals (0.0/0.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/tts-unittest/50}{tts-unittest}.
