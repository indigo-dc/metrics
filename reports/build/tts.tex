...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=82]{\textbf{\#2867} tts SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/tts-codestyle/110}{tts-codestyle}.
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/tts-unittest/96}{tts-unittest}.
