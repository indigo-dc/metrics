...
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/cloudproviderranker-codestyle/8}{cloudproviderranker-codestyle}.
...
\subsection{Observations}
\begin{enumerate}
        \item Even though there are quite some work in unit testing in the code, the overall coverage is just 1\% since conditional testing is just 1/150 covered.
    \end{enumerate}
