...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (40\% done)} \\
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{41\%} \\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=40]{\textbf{\#3065} java-syncrepos SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/java-syncrepos}\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-codestyle/36}{syncrepos-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_syncrepos-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=72.72727]{Files (8.0/11.0)}{1}{3} \\
            \ganttbar[progress=50.0]{Classes (10.0/20.0)}{1}{3} \\
            \ganttbar[progress=52.173912]{Methods (48.0/92.0)}{1}{3} \\
            \ganttbar[progress=41.31627]{Lines (226.0/547.0)}{1}{3} \\
            \ganttbar[progress=36.78161]{Conditionals (64.0/174.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-unittest/34}{syncrepos-unittest}.
