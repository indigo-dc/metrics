...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (17\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=17]{\textbf{\#3434}  SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{enumerate}
        \item Product leader/s did not provide this information. WP3 will check for the \href{https://source.android.com/source/code-style.html}{official Android guidelines} otherwise.
    \end{enumerate}
