...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=55]{\textbf{\#2945} pOCCI SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_pocci-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=21.861685]{Lines (3335.0/15255.0)}{1}{3} \\
            \ganttbar[progress=100.0]{Conditionals (0.0/0.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/pocci-unittest/5}{pocci-unittest}.
