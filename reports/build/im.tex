...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{31\%} \\ 
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/im-codestyle/52}{im-codestyle}.
...
\begin{enumerate}
        \item Task is at 50\% since the Ansible playbook does not cover configuration.
    \end{enumerate}
