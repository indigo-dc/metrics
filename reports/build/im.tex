...
\href{https://jenkins.indigo-datacloud.eu:8080//job/im-codestyle/70}{im-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=63.337803]{Lines (6615.0/10444.0)}{1}{3} \\
...
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/im-unittest/63}{im-unittest}.
