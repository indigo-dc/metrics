...
\title{Software Quality Assurance (SQA) Report \\[0.7em] \large{13-17 Jun 2016}\\[1.5em] 
       \huge{\texttt{Infrastructure Manager}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (72\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=72]{\textbf{\#2963} Infrastructure Manager SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/im.git}\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/im-codestyle/54}{im-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_im-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=95.55556]{Files (43.0/45.0)}{1}{3} \\
            \ganttbar[progress=95.55556]{Classes (43.0/45.0)}{1}{3} \\
            \ganttbar[progress=31.416721]{Lines (3333.0/10609.0)}{1}{3} \\
            \ganttbar[progress=100.0]{Conditionals (0.0/0.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/im-unittest/35}{im-unittest}.
\subsection{Observations}
\begin{enumerate}
        \item Product team has added new unit tests not currently being integrated in Jenkins service (WP3 in progress).
    \end{enumerate}
...
\begin{center}
\begin{tabular}{ll}
        \href{https://jenkins.indigo-datacloud.eu:8080/job/im-ansible/label=ansible-ubuntu/}{Ubuntu 14.04 LTS} & \redbox{failed}\\
        \href{https://jenkins.indigo-datacloud.eu:8080/job/im-ansible/label=ansible-centos/}{CentOS7} & \greenbox{successful}\\
    \end{tabular}
\end{center}
\subsection{Observations}
\begin{enumerate}
        \item Task is at 50\% since the Ansible playbook does not cover configuration. Product team has confirmed that configuration will be added as well.
    \end{enumerate}
