...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}8\% done\end{huge}} 
    %\\[0.5em] 
    %    %    \redbox{\strut \begin{huge}8\% done\end{huge}}
    % \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=8]{\textbf{\#3452} Ophidia analytics workflow interfaces SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
...
\begin{enumerate}
        \item Product team uses K\&R indent style. The Jenkins job will be defined whenever the code is available in indigo-dc.
    \end{enumerate}
...
\subsection{Observations}
\begin{enumerate}
        \item Documentation of the contributions of Ophidia to INDIGO-DataCloud is not clearly identified. Settin progress to 50\%.
    \end{enumerate}
