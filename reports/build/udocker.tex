...
\begin{tabular}{ll}
    Code style definition & \href{https://www.python.org/dev/peps/pep-0008/}{PEP 8 -- Style Guide for Python Code} \\
...
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/udocker-codestyle/24}{udocker-codestyle}.
