...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (52\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=52]{\textbf{\#2996} Synergy Service SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/synergy-service}\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-codestyle/5}{synergy-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_synergy-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=50.0]{Packages (2.0/4.0)}{1}{3} \\
            \ganttbar[progress=23.076923]{Files (3.0/13.0)}{1}{3} \\
            \ganttbar[progress=23.076923]{Classes (3.0/13.0)}{1}{3} \\
            \ganttbar[progress=5.5753264]{Lines (47.0/843.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Conditionals (0.0/218.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}
\subsection{Build status}
Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-unittest/4}{synergy-unittest}.
