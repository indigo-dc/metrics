...
\title{INDIGO-DataCloud Software Quality Assurance (SQA) Report Apr-Jun 2016\\[1.5em] 
       \huge{\texttt{INDIGO-DataCLoud Identity-Harmonization Service}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE (50\% done)} \\
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=50]{\textbf{\#2876} INDIGO-DataCLoud Identity-Harmonization Service SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/identity-harmonization.git}\end{center}
...
\begin{enumerate}
        \item The command provided for running the tests is currently failing.
    \end{enumerate}
