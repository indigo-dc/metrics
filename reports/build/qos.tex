...
Repository exists under \texttt{indigo-dc} GitHub organization: \vspace{0.1em} \begin{center}\url{https://github.com/indigo-dc/CDMI}\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/qos-codestyle/5}{qos-codestyle}.
...
\includegraphics[scale=0.5]{/srv/metrics/reports/build/figs/graph_qos-unittest.png}
\\
%\vspace{0.5em}
