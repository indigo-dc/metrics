...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=0]{\textbf{\#3119} INDIGO IAM SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3122} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3848} Code style specification}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3125} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3128} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3131} Configuration management}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3134} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
