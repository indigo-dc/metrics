...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=0]{\textbf{\#3269} Accounting SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{enumerate}
        \item Task is at 50\% of progress since the standards are defined but the Jenkins jobs are failing.
    \end{enumerate}
